...
#include <stdexcept>
	...
	{
		if (containsKey(key)) //toto asi prec => lebo pomale
		{
			throw std::invalid_argument("Key is already in table");
		}
		else
		{
	...
	{
		//lebo list vie iterovat, tak nam staci zavolat iba jeho iterator
